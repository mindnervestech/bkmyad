...
public class AddPackageController extends Controller {
	...
	@Transactional
	public static Result getDiscountRate(String newsPaper, String Category,
			int currentPage) {
		long totalPages = Discountprice.getAllPackageRateTotal(newsPaper,
				Category, 50);
		List<Discountprice> allPackgeRate = Discountprice.getAllPackageRate(
				newsPaper, Category, currentPage, 50, totalPages);
